...
class ComsolSolution:
    def __init__(self, r0, delta, hh, N, E, nu, alpha, path):
        ...
        f1_r_data = comsol[:, 0]
        f1_data = comsol[:, 1] / (lam + 2 * mu)/alpha
