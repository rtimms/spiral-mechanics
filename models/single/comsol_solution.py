...
class ComsolSolution:
    def __init__(self, r0, delta, hh, N, mu, lam, alpha, alpha_cc, alpha_scale, path):
        """
        ...
        # f1 = sigma_rr
        comsol = pd.read_csv(path + "srr3.csv", comment="#",
        ...
        # g1 = sigma_rt
        comsol = pd.read_csv(path + "srt3.csv", comment="#",
                             header=None).to_numpy()
        g1_r_data = comsol[:, 0]
        ...
        comsol = pd.read_csv(path + "v1.csv", comment="#",
                             header=None).to_numpy()
        g2_r_data = comsol[:, 0]
        ...
        # radial displacement
        comsol = pd.read_csv(path + "u3.csv", comment="#",
                             header=None).to_numpy()
        u_r_data = comsol[:, 0]
        ...
        comsol = pd.read_csv(path + "v3.csv", comment="#",
                             header=None).to_numpy()
        v_r_data = comsol[:, 0]
        ...
        # radial strain
        comsol = pd.read_csv(path + "err3.csv", comment="#",
                             header=None).to_numpy()
        err_r_data = comsol[:, 0]
        ...
        # azimuthal strain
        comsol = pd.read_csv(path + "ett3.csv", comment="#",
                             header=None).to_numpy()
        ett_r_data = comsol[:, 0]
        ...
        # shear strain
        comsol = pd.read_csv(path + "ert3.csv", comment="#",
                             header=None).to_numpy()
        ert_r_data = comsol[:, 0]
        ...
        # azimuthal stress
        comsol = pd.read_csv(path + "stt3.csv", comment="#",
                             header=None).to_numpy()
        stt_r_data = comsol[:, 0]
        ...
        comsola = pd.read_csv(path + "T1.csv", comment="#",
                              header=None).to_numpy()
        T_r_dataa = comsola[:, 0]
...
class ComsolInnerSolution:
    def __init__(self, path):
        ...
        comsol = pd.read_csv(path + "u_grid.csv",
