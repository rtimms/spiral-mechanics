...
winds = [r0 + delta * n for n in list(range(N_plot))]  # centre
winds_p = [r0 + hh / 2 + delta * n for n in list(range(N_plot))]

# get r, theta values
r = np.array(list(itertools.chain(*zip(winds[:-1], winds[1:]))))
theta = np.array(list(itertools.chain(*zip(theta[:-1], theta[:-1]))))
...
ax[0, 0].plot(r, f2(theta), "o", color="tab:blue", label=r"$f_2$")
ax[0, 0].plot(r, f2_comsol(theta), "x", color="tab:orange", label=r"$f_2$ (COMSOL)")
...
ax[0, 1].plot(r, g2(theta), "o", color="tab:blue", label=r"$g_2$")
ax[0, 1].plot(
    r + hh / 2, g2_comsol(theta), "x", color="tab:orange", label=r"$g_2$ (COMSOL)"
)
...
ax[1, 0].plot(r, f1(theta), "o", color="tab:blue", label=r"$f_1$")
ax[1, 0].plot(
    r + hh / 2, f1_comsol(theta), "x", color="tab:orange", label=r"$f_1$ COMSOL"
)
...
ax[1, 1].plot(r, g1(theta), "o", color="tab:blue", label=r"$g_1$")
ax[1, 1].plot(
    r + hh / 2, g1_comsol(theta), "x", color="tab:orange", label=r"$g_1$ (COMSOL)"
)
